...
export function AuthForm({ onAuthSuccess }: AuthFormProps) {
  ...
  const { token: captchaToken, status: captchaStatus, ensureToken, resetWidget: resetCaptcha } = useTurnstile('turnstile-container');
  ...
  return (
    <div className="min-h-screen bg-gradient-bg flex items-center justify-center p-4 pt-safe-top relative overflow-hidden">

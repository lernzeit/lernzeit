-- Remove all visual/drawing templates by setting status to ARCHIVED or DELETE them
...
VALUES ('visual_templates_deleted', json_build_object(
  'timestamp', now(),
  'reason', 'UI does not support drawing/visual tasks',
  'action', 'Deleted visual templates from database'
));